var menus_text = ['Γάλα, καφές, τσάι, χυμός, βούτυρο, άρτος, μέλι, κέικ', 'Πρώτο Πιάτο: Ψαρόσουπα\nΚυρίως Πιάτο: Καλαμαράκια κοκκινιστά με πιλάφι ή Βακαλάος αλά σπετσιώτα και πανέ με πατάτες\nφούρνου\nΜπουφές Σαλάτα: Μπρόκολο ή κουνουπίδι βραστό, καρότο, μαρούλι με κρεμμύδια φρέσκα, ρόκα, λόλα, λάχανο άσπρο,\nκόκκινο,μανιτάρια\nΕπιδόρπιο: Φρούτο Εποχής 2 επιλογές, Αναψυκτικό', 'Πρώτο Πιάτο: Τοματόσουπα\nΚυρίως Πιάτο: Μακαρόνια με  κιμά\nτυρί τριμμένο ή Ομελέτα με ή χωρίς αλλαντικά και τυριά πατάτες τηγανιτές\nΜπουφές Σαλάτα: Μαρούλι με κρεμμύδια φρέσκα, ρόκα, λόλα λάχανο, άσπρο, κόκκινο, καρότο\nΕπιδόρπιο: Φρούτο Εποχής 2 επιλογές, Γιαούρτι'];
var last_update_datetime = "2024-03-27 21:08:40";
