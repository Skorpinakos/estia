var menus_text = ['Πρώτο Πιάτο: Σούπα λαχανικών\nΚυρίως Πιάτο: Κοτόπουλο ψητό με λαζανάκι ή Χοιρινή μπριζόλα ψητή με πατάτες τηγανιτές\nΜπουφές Σαλάτα: Μαρούλι, ρόκα, λόλα, κρουτόν, λάχανο άσπρο- κόκκινο,πολίτικη, καλαμπόκι, μουστάρδα\nΕπιδόρπιο: Φρούτο Εποχής 2 επιλογές, ', 'Πρώτο Πιάτο: Κους κους με μανιτάρια\nΚυρίως Πιάτο: Αρακάς λαδερός με\nπατάτες ή Πατάτες γιαχνί με μανιτάρια\nΜπουφές Σαλάτα: Ντομάτα, πιπεριά, κρεμμύδι, μαρούλι, κρεμμυδάκι φρέσκο ρόκα ,λόλα\nΕπιδόρπιο: Φρούτο Εποχής 2 επιλογές, Τυρί φέτα', 'Γάλα, καφές, τσάι, χυμός, βούτυρο, άρτος, μέλι, κέικ'];
var last_update_datetime = "2024-03-28 00:03:28";
