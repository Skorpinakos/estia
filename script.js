var menus_text = ['Γάλα, καφές, τσάι, χυμός, βούτυρο, άρτος, μαρμελάδα, τυρόπιτα', 'Πρώτο Πιάτο:Λαχανόρυζο\nΚυρίως Πιάτο: Πέννες καρμπονάρα τυρί τριμμένο\xa0ή Μακαρόνια με κιμά τυρί τριμμένο\nΜπουφές Σαλάτα:Μαρούλι με κρεμμύδια φρέσκα, ρόκα, λόλα λάχανο, άσπρο, κόκκινο, καρότο,ελιές\nΕπιδόρπιο:Φρούτο Εποχής 2 επιλογές', 'Πρώτο Πιάτο:Μινεστρόνε\nΚυρίως Πιάτο:Γιουβέτσι λαχανικών ή Γιουβαρλάκια αυγολέμονο\nΜπουφές Σαλάτα:Μαρούλι με κρεμμύδια φρέσκα, ρόκα λόλα λάχανο, άσπρο-κόκκινο, καρότο\nΕπιδόρπιο:Φρούτο Εποχής 2 επιλογές, Κομπόστα'];
var last_update_datetime = "2024-04-01 21:11:39";
