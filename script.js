var menus_text = ['Γάλα, καφές, τσάι, χυμός ,βούτυρο, άρτος, μέλι, κέικ', 'Πρώτο Πιάτο: Ψαρόσουπα\nΚυρίως Πιάτο: Γαρίδες σαγανάκι με πιλάφι ή Βακαλάος αλά σπετσιώτα και πανέ με πατάτες φούρνου\nΜπουφές Σαλάτα: Μπρόκολο ή κουνουπίδι βραστό, καρότο, μαρούλι με κρεμμύδια φρέσκα, ρόκα, λόλα, λάχανο άσπρο, κόκκινο\nΕπιδόρπιο: Φρούτο Εποχής 2 επιλογές, ', 'Πρώτο Πιάτο: Τοματόσουπα\nΚυρίως Πιάτο: Μακαρόνια με σάλτσα αματριτσιάνα  τυρί τριμμένο ή Ομελέτα με ή χωρίς αλλαντικά και τυριά- πατάτες τηγανιτές\nΜπουφές Σαλάτα: Μαρούλι με κρεμμύδια φρέσκα, ρόκα λόλα λάχανο, άσπρο-κόκκινο, καρότο\nΕπιδόρπιο: Φρούτο Εποχής 2 επιλογές, Γιαούρτι'];
var last_update_datetime = "2024-04-03 21:12:02";
